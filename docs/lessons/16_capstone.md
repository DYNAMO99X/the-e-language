# Lesson 19 — Capstone: a tiny text adventure
...
From Lesson 16, the four-step plan:
...
- `while` and `repeat` (Lesson 9)
- Lists, `size of`, `at`, and `with ... added` (Lesson 10)
- Functions with `to`/`end`, parameters, and `return` (Lesson 11)
- `is not equal to` (Lesson 8)
- Recursion? Not directly, but `has_key` uses a loop with state,
  which is the same idea. (Lesson 12)
- All the debugging skills from Lesson 15
- The four-step plan from Lesson 16
