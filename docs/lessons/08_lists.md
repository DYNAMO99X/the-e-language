# Lesson 8 — Lists (a row of things)
...
in Lesson 7: `let n be n plus 1` — the new value replaces the old.
...
This works but it's clunky. In Lesson 11 (turtle 2) you'll learn a
cleaner way.
...
If yes, on to Lesson 9 — your own commands (functions)!
